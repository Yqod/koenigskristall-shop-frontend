        ...
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-8">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <div className="flex gap-3 ml-6 sm:ml-12 mt-2">
              ...
              <a href="tel:+491234567890" aria-label="Telefon" className="text-muted-foreground hover:text-primary transition">
                <div className="w-5 h-5 mr-2" style={{backgroundImage: "url('/anruf.png')", backgroundSize: "cover", backgroundPosition: "center"}}></div>
              </a>
              <a href="https://instagram.com/koenigskristall" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-red-600 hover:text-red-800 transition">
                <div className="w-5 h-5 mr-2" style={{backgroundImage: "url('/instagram.png')", backgroundSize: "cover", backgroundPosition: "center"}}></div>
              </a>
              <a href="https://www.tiktok.com/@koenigskristall" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-pink-600 hover:text-pink-800 transition">
                <div className="w-5 h-5 mr-2" style={{backgroundImage: "url('/tick-tack.png')", backgroundSize: "cover", backgroundPosition: "center"}}></div>
              </a>
           </div>
          </div>
